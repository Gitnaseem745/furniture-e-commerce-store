...
const Newsletter: React.FC = () => {
  return (
    <div className="flex flex-row justify-between items-center px-32 text-white py-10 mb-[-49px] w-full bg-[#152420] flex-wrap gap-10 max-md:justify-center">
        ...
        <div className="relative max-w-full">
            <input type="text" placeholder="Your email*" className="w-[600px] max-md:w-[400px] bg-transparent focus:outline-none border-[2px] border-[#264B4E] rounded-full p-5"/>
